...
public class AddUser_Librarian21 {
    public static void main(String[] args)throws Exception {
        ...
        CustomMethods.takeSnapShot(driver, "C://Users/Robin.000/OneDrive/Fotos/Selenium ScrShot/LibraryCT/AddUserFunctionality/Librarian21_AddUser/1_login_page.png");
        ...
        CustomMethods.takeSnapShot(driver, "C://Users/Robin.000/OneDrive/Fotos/Selenium ScrShot/LibraryCT/AddUserFunctionality/Librarian21_AddUser/2_Librarian53_credentials.png");

        driver.findElement(By.xpath("//*[@id=\"login-form\"]/button")).click();

        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href=\"#users\"]")));
        CustomMethods.takeSnapShot(driver, "C://Users/Robin.000/OneDrive/Fotos/Selenium ScrShot/LibraryCT/AddUserFunctionality/Librarian21_AddUser/3_MainPage.png");
        ...
        CustomMethods.takeSnapShot(driver, "C://Users/Robin.000/OneDrive/Fotos/Selenium ScrShot/LibraryCT/AddUserFunctionality/Librarian21_AddUser/4_FillInfo.png");
        ...
        newEmail.sendKeys("robinsonmartinez200@cybertek.com");

        WebElement address = driver.findElement(By.xpath("//*[@id='address']"));
        address.sendKeys("Miami Beach, FL 33141");

        CustomMethods.takeSnapShot(driver, "C://Users/Robin.000/OneDrive/Fotos/Selenium ScrShot/LibraryCT/AddUserFunctionality/Librarian21_AddUser/5_InfoFilled.png");

        driver.findElement(By.xpath("//button[@type='submit']")).click();

        Thread.sleep(3000);
        CustomMethods.takeSnapShot(driver, "C://Users/Robin.000/OneDrive/Fotos/Selenium ScrShot/LibraryCT/AddUserFunctionality/Librarian21_AddUser/6_UserAdded.png");
